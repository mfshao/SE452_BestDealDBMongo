...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			dbUser = utility.getUser(username);
		} catch (SQLException e) {
			RequestDispatcher rd = request.getRequestDispatcher("DBConnectionError");
	...
	protected void displayLogin(HttpServletRequest request, HttpServletResponse response, PrintWriter pw, boolean error)
		...
		pw.print("<form method='post' action='Login'>" + "<table style='width:100%'><tr><td>"
				...
				+ "</td></tr><tr><td></td><td>"
				+ "<input type='submit' class='btnnormal' value='Login' style='float: right;height: 20px margin: 20px; margin-right: 10px;'></input>"
				+ "</td></tr><tr><td></td><td>"
